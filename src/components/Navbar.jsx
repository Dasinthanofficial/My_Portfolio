...
// match actual mobile nav height used below
function getNavHeight() {
...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className="
          fixed top-0 md:top-6 left-0 md:left-1/2 md:-translate-x-1/2
          w-full md:w-[calc(100%-64px)] max-w-[1280px]
          h-16 md:h-auto
          flex justify-between items-center
          px-4 md:px-8 py-2 md:py-3
          bg-glass-bg backdrop-blur-glass border-b md:border border-glass-border shadow-glass
      ...
      >
        ...
        >
          ...
          {/* Optional brand text on mobile (helps avoid “only D floating”) */}
