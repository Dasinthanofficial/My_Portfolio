...
// import { FaAws, FaCss3Alt, FaGitAlt, FaGithub, FaHtml5, FaJs, FaNodeJs, FaPython, FaReact } from 'react-icons/fa';
...
//       <div className="h-full bg-accent rounded-full shadow-[0_0_10px_var(--accent-primary)]" style={{ width: `${level}%` }} />
//     </div>
//   );
...
//             <h3 className={`text-xl mb-6 font-bold flex items-center gap-2.5 ${cat.priority ? 'text-accent' : 'text-white'}`}>
//               {cat.category}
//               {cat.priority && <span className="text-xs bg-accent text-white px-2 py-0.5 rounded shadow-sm">Main strength</span>}
//             </h3>
...
//                       {skill.isBasic && (
//                         <span className="text-[10px] px-1.5 py-0.5 border border-white/20 rounded text-text-muted">Basic</span>
//                       )}
//                     </div>
//                   </div>
...
const SkillsSection = () => {
  ...
  return (
    <section className="px-5 pb-20 pt-0 md:px-20 md:pb-24" id="skills">
      ...
      {/* ✅ min width reduced for mobile safety */}
