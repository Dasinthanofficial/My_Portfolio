...
import { FaAws, FaLaptopCode, FaPython, FaRocket, FaServer, FaUserShield } from 'react-icons/fa';
    ...
    <section className="px-5 pb-20 pt-0 md:px-20 md:pb-24" id="services">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-[repeat(auto-fit,minmax(300px,1fr))] gap-6">
        {services.map((item, index) => (
          <GlassCard key={index} hoverEffect className="h-full flex flex-col group">
            <div
              className="text-5xl mb-6 text-white drop-shadow-[0_0_15px_rgba(164,58,217,0.5)] 
            ...
            <p className="text-text-muted text-[15px] leading-relaxed mb-6 flex-1">{item.desc}</p>
