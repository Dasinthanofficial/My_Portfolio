                    ...
                    <div className="flex flex-col sm:flex-row gap-7 items-center sm:items-start">
                        ...
                        <div className="flex-1 text-center sm:text-left">
                            <h3 className="text-3xl font-bold text-white mb-3.5 leading-tight font-heading">
                                Hi, I'm <span className="text-accent drop-shadow-[0_0_10px_rgba(164,58,217,0.4)]">Dasinthan.</span> <br />
                                Full-Stack Developer
                            </h3>
                            <p className="text-text-muted leading-relaxed mb-6 text-[15px]">
                                I am a passionate Developer with a strong command of the MERN stack. 
                                My journey started with Python scripting and has evolved into building scalable, full-featured web applications.
                            </p>
                            
                            {/* Status Badge */}
                            <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-accent/15 rounded-full 
                                          text-[#E0AAFF] text-[13px] font-semibold border border-accent/30 
                                          shadow-[0_0_15px_rgba(164,58,217,0.2)]">
                                <span className="w-2 h-2 bg-accent rounded-full shadow-[0_0_10px_var(--accent-primary)] animate-pulse"></span>
                                Open to Internship
                            </div>
                        </div>
                    </div>
...
// Internal component to reduce repetition
const StatCard = ({ number, label, isAccent = false }) => (
    <GlassCard hoverEffect className="flex flex-col justify-center items-center text-center py-8">
        <h4 className={`text-[42px] font-bold mb-1 font-heading 
            ${isAccent 
