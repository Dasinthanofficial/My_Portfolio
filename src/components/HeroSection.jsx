    ...
    return (
        ...
        >
            ...
            <div className="max-w-[650px] z-10 flex flex-col items-center lg:items-start flex-[1.2]">
                ...
                {/* Intro Text */}
                <h2 className="text-[clamp(24px,3vw,32px)] font-medium text-white/70 mb-2 leading-tight 
                             opacity-0 animate-[fadeInLeft_1s_ease_0.2s_forwards]">
                    Hello, I'm
                </h2>

                {/* Main Title */}
                <h1 className="text-[clamp(45px,9vw,95px)] font-black mb-7 leading-none tracking-tight lg:tracking-[-2px] pb-2.5
                ...
                {/* Description */}
                <p className="text-text-muted text-[clamp(16px,1.5vw,19px)] leading-relaxed mb-10 max-w-[550px]
                            opacity-0 animate-[fadeInLeft_1s_ease_0.6s_forwards]">
                    I am a passionate Full-Stack Developer specializing in the MERN stack (MongoDB, Express, React, Node.js). 
                    I build scalable, modern web applications and am actively seeking an <span className="text-white font-semibold">Internship</span> to apply my skills and contribute to real-world projects.
                </p>

                {/* CTA Buttons */}
                <div className="flex gap-5 mb-10 flex-wrap justify-center lg:justify-start
            ...
            {/* Right Content: Interactive Tech Icon Sphere */}
            <div className="flex-1 flex justify-center items-center z-10 min-w-full lg:min-w-[400px] 
