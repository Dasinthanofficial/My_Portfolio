...
//           <div className="flex gap-3 sm:gap-4 mb-6 flex-wrap justify-center lg:justify-start w-full">
//             <Button
//               variant="primary"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
        ...
        {/* ✅ Hide heavy sphere on mobile to prevent overlap and improve layout */}
